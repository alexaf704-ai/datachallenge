...
Código (/code/)
Scripts en R para:
Limpieza y preparación de los datos de Inside Airbnb.
Cruce espacial entre listados y límites de alcaldías/colonias.
Generación de variables relevantes (ingresos estimados, ocupación, precios, etc.).
Construcción de métricas comparables entre zonas.
Análisis econométrico (regresiones, pruebas, visualizaciones, etc.).
Generación de tablas y gráficas incluidas en el informe.
Datos (/data/)
...
Bases externas utilizadas en el proyecto (ej.: seguridad, transporte, contaminación, etc.).
...
Informe
Informe_Data_Challenge.pdf — Documento final entregado.
2. Contribución de cada integrante del equipo
(Modifica los nombres y roles según tu equipo; aquí te dejo un formato preciso y profesional.)
Integrante 1 (Nombre):
...
No se usó IA para:
Generar análisis econométrico automáticamente.
Crear el informe final sin supervisión.
Manipular o inventar datos.
Toda la lógica, decisiones analíticas, estimaciones y resultados fueron realizados directamente por el equipo.
